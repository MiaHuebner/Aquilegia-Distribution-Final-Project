...
##### Under the 'path' arguments, make sure to change the path to a valid path in your computer!! You have to change 2 lines of code here! 

```{r}
Global_Current_Data <- geodata::worldclim_global(
  var = 'bio', 
  res = 5, 
  path = 'ENTER A VALID PATHWAY FOR YOUR COMPUTER', 
...
North_America_Boundary <- geodata::gadm(
  ...
  level = 0, 
  path = tempdir('ENTER A VALID PATHWAY FOR YOUR COMPUTER')
)
